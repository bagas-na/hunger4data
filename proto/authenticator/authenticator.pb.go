...
func (x *LoginResponse) Reset() {
	*x = LoginResponse{}
	mi := &file_authenticator_authenticator_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LoginResponse) Descriptor() ([]byte, []int) {
	return file_authenticator_authenticator_proto_rawDescGZIP(), []int{4}
}
...
const file_authenticator_authenticator_proto_rawDesc = "" +
	"\n" +
	"!authenticator/authenticator.proto\x12\x10authenticator.v1\"b\n" +
	"\x04User\x12\x0e\n" +
